...
const EditIngredientSchema = Yup.object().shape({
...
const EditIngredientDialog = ({ open, onClose, form, onFormChange, onSubmit, isLoading }) => (
  <Dialog 
    open={open} 
  ...
  >
    ...
    <Formik
      initialValues={form}
      validationSchema={EditIngredientSchema}
      enableReinitialize
      onSubmit={onSubmit}
    >
