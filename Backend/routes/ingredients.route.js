...
import { addIngredientValidation, updateIngredientValidation } from '../validations/ingredientsValidations.js';
...
router.put('/update-ingredient', isAuthenticated, checkRole(['admin']), validate(updateIngredientValidation), updateIngredient);
