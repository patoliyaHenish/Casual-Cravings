...
router.post('/create-recipe-sub-category', isAuthenticated, checkRole(['admin']), validate(recipeSubCategoryValidationSchema), createRecipeSubCategory);
router.put('/update-recipe-sub-category', isAuthenticated, checkRole(['admin']), validate(recipeSubCategoryValidationSchema), updateRecipeSubCategory);
